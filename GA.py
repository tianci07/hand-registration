...
plt.imsave("./00382-s1-neg2/GA-1000/target.png", target_image, cmap='Greys_r');
...
plt.imsave("./00382-s1-neg2/GA-1000/pred.png", pred_image, cmap='Greys_r');
...
plt.imsave("./00382-s1-neg2/GA-1000/error-map.png", error_map, cmap='Greys_r');

correlation_map = target_image*pred_image;
plt.imsave("./00382-s1-neg2/GA-1000/correlation-map.png", correlation_map, cmap='Greys_r');

df.to_csv("./00382-s1-neg2/GA-1000/results.csv" );
